...
public class PersonaDaoImpl implements PersonaDao {
	...
	/*
	 * Asignamos los datasources a las plantillas 
	 * de manera manual
	@Autowired
	...
	*/
	...
	private static final String SQL_INSERT_PERSONA = "INSERT INTO PERSONA (nombre, ape_paterno, ape_materno, email) values "
			+ "(:nombre,	:apePaterno, :apeMaterno, :email)";
