...
public class TestPersonaServiceImpl {
	...
	@Autowired
	//En caso de que halla mas de de 1 bean de tipo PersonaService
	//@Qualifier("PersonaService1") 
	private PersonaService personaService;

	@Autowired
	//En caso de que halla mas de de 1 bean de tipo personaDao
	// @Qualifier("personaDAO1")
	private PersonaDao personaDao;

	@Test
	//Al agregar esta Anotacion en una prueba unitaria, se hace un Rollback al terminar la prueba
	//esto con la finalidad de no afectar a la BD con los casos de pruebas
	@Transactional
	@Ignore
	...
	public void testOperaciones() {
		try {
			...
			persona1.setNombre("Andrea1");
			persona1.setApePaterno("Lara1");
			persona1.setEmail("andrea.lara@mimail.com1");
